...
//    LOG.info("basicindexingfilter prevfetchtime:"+simpleDateFormat.format(new Date(page.getPrevFetchTime())));
//    LOG.info("basicindexingfilter fetchtime:"+simpleDateFormat.format(new Date(page.getFetchTime())));
    //因为原来的bug，没有添加prefetch这个field，因此才会出现prefetch time总是为0，我们修复了这个bug
