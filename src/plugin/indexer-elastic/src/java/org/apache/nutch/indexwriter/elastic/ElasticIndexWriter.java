...
//          .addTransportAddress(new InetSocketTransportAddress(host, port));
      LOG.info("into host and port");
      TransportClient.Builder builder=TransportClient.builder();
      builder.settings(settingsBuilder);
      client = builder.build().addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName(host),port));
  ...
  public void write(NutchDocument doc) throws IOException {
    ...
    for (String fieldName : doc.getFieldNames()) {
      LOG.info("ElasticIndexWriter field:"+fieldName);
