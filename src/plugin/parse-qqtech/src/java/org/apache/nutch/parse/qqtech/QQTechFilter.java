 ...
 */
package org.apache.nutch.parse.qqtech;
 ...
 */
public class QQTechFilter extends RegexURLFilterBase implements ParseFilter {
  public static final Logger LOG = LoggerFactory
      .getLogger(QQTechFilter.class);
...
public QQTechFilter() {
  ...
  public QQTechFilter(String filename) throws IOException,
          PatternSyntaxException {
    super(filename);
  }

  QQTechFilter(Reader reader) throws IOException, IllegalArgumentException {
    super(reader);
  }
  @Override
  ...
  protected Reader getRulesReader(Configuration conf) throws IOException {
    String fileRules = conf.get(QQTECH_REGEX_FILE);
  ...
  public static final String QQTECH_REGEX_FILE = "qqtechindexingfilter.regex.file";
  //----------------------------------------------------------------------------------
...
//        System.out.println("combine.text :"+combine.text );
//        System.out.println("combine.time :"+combine.time );
